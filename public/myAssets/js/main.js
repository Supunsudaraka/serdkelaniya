    ...
    $(document).ready(function () {
        ...
        if ($('#xs-contact-form').length > 0) {
            $('#xs-contact-form').on('submit', function (event) {
                ...
                $('.hdhdhdhdhdhdd_success_message').remove();
                ...
                if (error === false) {
                    $.ajax({
                        ...
                        success: function (result) {
                            submit.after('<p class="hdhdhdhdhdhdd_success_message">' + result + '</p>').fadeIn();
                            setTimeout(() => {
                                $('.hdhdhdhdhdhdd_success_message').fadeOut();
                            }, 3000);
