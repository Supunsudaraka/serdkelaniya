...
@section('pageSpecificContent')
    ...
    <section class="xs-banner-inner-section parallax-window" style="background-image:url({{\Illuminate\Support\Facades\URL::asset('myAssets/images/victories/victory.jpeg')}})">
        ...
        <section class="xs-content-section-padding">
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-12">
                        <h2 style="text-align: center">{{__('common.victories-heading')}}</h2>
                        <div class="progress">
  ...
  <h6 class="less-{{$victory->idvictory}}"  style="text-align: left">{{Str::limit(strip_tags($victory->description), 120)}}</h6>
                                                            <h6 id="more"  class="more-{{$victory->idvictory}} hide"  style="text-align: left">{{$victory->description}}</h6>
                                                            <a  href="{{route('victory-view',['language'=>app()->getLocale(),'id'=>$victory->idvictory])}}"  class="btn-md btn text-white btn-success" >{{__('common.READ MORE')}}</a>
                                ...
                                @endforeach
                                    @else
                                        <div class="col-md-12">
                                            <h4>{{__('common.noVictoriesText')}}</h4>
                                        </div>
                                    @endif
                            </div>
                        </div>
