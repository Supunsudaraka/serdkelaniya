                    ...
                    <div class="card-section card-section-second border rounded ml-4 mr-4">
                        <div class="card-body text-center card-body-second">
                            <div class="scroll-animations">
                                ...
                                <form method="post" action="{{route('news-upload',app()->getLocale())}}" enctype="multipart/form-data"
...
//                    console.log(response);
        ...
        $("#saveForm").on("submit", function (event) {
            ...
            $.post('{{route('news-store',app()->getLocale())}}',
                $(this).serialize(), function (data) {
                    ...
                    if (data.success != null) {
                        swal("Saved!", "News saved successfully!", "success");
