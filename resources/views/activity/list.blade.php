...
@section('pageSpecificContent')
    ...
    <section class="xs-banner-inner-section parallax-window" style="background-size: cover;background-image:url({{\Illuminate\Support\Facades\URL::asset('myAssets/images/activity/'.$category->image)}})">
            ...
            <div class="container">
                ...
                <div class="row" style="padding-top: 10px">
                    @if(count($activities) == 0)
                        ...
                        <h4 class="card-title">{{__('common.No activities yet.')}}</h4>
                        </div>
                    @else
                        ...
                        <div class="col-lg-4">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <!-- Title -->
                                    <h4 style="min-height: 56px;"   class="card-title">{{Str::limit($activity->name, 38)}}</h4>
                                    <!-- Text -->
                                    <p style="min-height: 75px;padding-bottom:0px;" class="card-text">{{Str::limit(strip_tags($activity->description), 120)}}</p>
                                    <!-- Button -->
                                    <a href="{{route('activity-show',['language'=>app()->getLocale(),'id'=>$activity->id])}}" class="btn btn-primary">View</a>
