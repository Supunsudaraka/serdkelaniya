                                                ...
                                                <div class="card">
                                                    ...
                                                    <div class="card-body">
                                                        ...
                                                        <a class="btn btn-danger"
                                                           data-id="{{$getImage->idactivity_image}}" id="dEImgId"><i
                                                                    style="color: black" class="fa fa-trash"
            ...
            <div class="row">
                <div class="col-lg-12 col-md-12 mb-3 card-main">
                    <div class="card-section card-section-second border rounded ml-4 mr-4">
                        <div class="card-body text-center card-body-second">
                            <div class="scroll-animations">
                                <form method="post" action="{{route('edit-activity-upload',app()->getLocale())}}"
                                      enctype="multipart/form-data"
                                      class="dropzone" id="dropzone">
                                    @csrf
                                    <input type="hidden" id="idactivity" name="idactivity" value="{{$idactivity}}">
                                </form>
                                    ...
                                    <div class="tab-content">
                                        <div id="Home" class="tab-pane fade in active">
                                            <div class="row" style="padding-top: 10px">
                                                <div class="col-lg-4">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <select class="form-control" style="height: 34px"
                                                            ...
                                                            @if(isset($activityCategories))
                                                                @foreach($activityCategories as $activityCategory)
                                                                    <option value="{{"$activityCategory->idactivity_category"}}">{{$activityCategory->name_en}} </option>
                                                                @endforeach
                                                            @endif
                                                ...
                                                <div class="col-lg-8">
                                                    <div class="form-group">
                                                        <label for="eName">Activity Name<span
...
<script>
    ...
    function getActivityDetail() {
        ...
        $.post('getActivityDetailById', {
            idactivity: idactivity
        }, function (data) {
            $("#category").val(data.activity.idactivity_category);
            $("#eName").val(data.activity.name_en);
            $("#eDescription").val(data.activity.description_en);
            $("#sName").val(data.activity.name_si);
            $("#sDescription").val(data.activity.description_si);
    ...
    $(document).on('click', '#dEImgId', function () {
        var activityImgId = $(this).data("id");

        $.post('activity-deleteImageById', {activityImgId: activityImgId}, function (data) {
            if (data.success) {
//                console.log(data)
                location.reload();
            }
    ...
    $("#updateForm").on("submit", function (event) {
        ...
        $.post('{{route('activityUpdate',app()->getLocale())}}',
            $(this).serialize(), function (data) {
                ...
                if (data.success != null) {
                    window.location = '{{route('view-activities',app()->getLocale())}}';
                }
